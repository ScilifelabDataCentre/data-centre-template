...
| [Renovate](.config/cspell/README.md)  | Allows repositories in ScilifelabDataCentre GitHub Organisation to use a custom Renovate preset in their Renovate configuration instead of teams building their own completely from scratch.                                                                                                         | -                                                                                                                 |
