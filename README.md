...
| [Citation instruction template](instructions/citing.md)              | Template for user-facing instructions on how to cite our services and code.                                                                                                                                                                                            | [Making Services and Code Citable](https://github.com/ScilifelabDataCentre/development-guidelines/blob/main/citing_and_citability/making-citable.md) |
