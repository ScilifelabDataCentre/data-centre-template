...
| -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`.development-guidelines-version`](.development-guidelines-version) |                                                                                                                                                                                              | [ADR Record: 0001-track-the-development-guidelines-version-with-renovate.md](docs/architecture/decisions/0001-track-the-development-guidelines-version-with-renovate.md) |
