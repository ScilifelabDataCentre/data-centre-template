...
- Provide a template for new repositories and copy-pastable template files / configurations for existing repositories, to simplify day-to-day work for the SciLifeLab Data Centre teams.
